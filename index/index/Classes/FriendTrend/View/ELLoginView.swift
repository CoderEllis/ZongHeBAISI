...
class ELLoginView: UIView {
    ...
    class func loadFromNib() -> ELLoginView {
        return Bundle.main.loadNibNamed("ELLoginView", owner: nil, options: nil)?.first as! ELLoginView
    }
    ...
    lazy var loginBtn : UIButton = {
        ...
        login.setTitle("登录", for: UIControl.State.normal)
        return login
    }()
    ...
    lazy var forgetBtn : UIButton = {
        ...
        forgetBtn.titleLabel?.textColor = UIColor.white
